...
using LimitesCreditoDBFirst.Models;

namespace LimitesCreditoDBFirst.Controllers
{
    public class LIMITES_CREDITOS_LICController : Controller
    {
        private CREDITODB db = new CREDITODB();

        // GET: LIMITES_CREDITOS_LIC
        public ActionResult Index()
        {
            return View(db.LIMITES_CREDITOS_LIC.ToList());
        }

        // GET: LIMITES_CREDITOS_LIC/Details/5
        ...
        // GET: LIMITES_CREDITOS_LIC/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: LIMITES_CREDITOS_LIC/Create
        ...
        // GET: LIMITES_CREDITOS_LIC/Edit/5
        ...
        // POST: LIMITES_CREDITOS_LIC/Edit/5
        // Para se proteger de mais ataques, ative as propriedades específicas a que você quer se conectar. Para 
        // obter mais detalhes, consulte https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: LIMITES_CREDITOS_LIC/Delete/5
        ...
        // POST: LIMITES_CREDITOS_LIC/Delete/5
